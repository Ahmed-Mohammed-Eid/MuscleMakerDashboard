                ...
                <div className="card border-round-xl">
                    <div className="flex flex-wrap gap-3 justify-content-between align-items-center">
                        <div className="flex gap-2">
                            ...
                            {/* update client selected meals */}
                            <Button severity="help" onClick={() => router.push(`/${locale}/users/edit-day-meals/${id}`)} tooltip={t('actions.editDayMeals')} className="p-button-rounded p-button-outlined">
