                    ...
                    <>
                        ...
                        <div className="flex">
                            <div className="field-radiobutton flex-1">
                                <RadioButton name="language" value={'en'} checked={layoutConfig.language === 'en'} onChange={(e) => setLayoutConfig((prevState: LayoutConfig) => ({ ...prevState, language: e.value }))} inputId="en" />
                                <label htmlFor="en">
                                    <Image src={'/en.svg'} alt={"en language"} width={22} height={16} />
                                </label>
                            </div>
                            <div className="field-radiobutton flex-1">
                                <RadioButton name="language" value={'ar'} checked={layoutConfig.language === 'ar'} onChange={(e) => setLayoutConfig((prevState: LayoutConfig) => ({ ...prevState, language: e.value }))} inputId="ar" />
                                <label htmlFor="ar">
                                    <Image src={'/ar.svg'} alt={"ar language"} width={22} height={16} />
                                </label>
                            </div>
                        </div>
