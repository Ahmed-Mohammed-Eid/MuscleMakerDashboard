...
export default function EditMeal({meal, id}) {
    ...
    function editMeal(event) {
        ...
        // VALIDATE THE FORM
        if (!form.mealTitle || !form.mealTitleEn || !form.mealPrice || !form.mealCategory || !form.mealType || !form.carbohydrate || !form.fat || !form.calories || !form.protein || !form.sugar || !form.mealFoodicsId || !form.mealDescription) {
    ...
    return (
        <form onSubmit={editMeal}>
            <div className={"card mb-2"}>
                <h1 className={"text-2xl font-bold mb-4 uppercase"}>Edit Meal</h1>
                ...
                <Button
                    ...
                    label={loading ?
                        <ProgressSpinner
                            fill={'#fff'}
                            strokeWidth={'4'}
                            style={{width: '2rem', height: '2rem'}}/> : `Edit Meal`}
                    disabled={loading}/>
            </div>
        </form>
    )
