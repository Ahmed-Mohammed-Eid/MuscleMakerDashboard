...
export default function CreatePackage() {
    ...
    function createBoxHandler(e) {
        ...
        axios.post(`${process.env.API_URL}/create/box`, formData, {
            headers: {
    ...
    return (
        <form onSubmit={createBoxHandler}>
            <div className={"card"}>
                <h1 className={"text-2xl font-bold mb-4 uppercase"}>Create Day Box</h1>
                ...
                <Button
                    ...
                    label={loading ?
                        <ProgressSpinner
                            fill={'#fff'}
                            strokeWidth={'4'}
                            style={{width: '2rem', height: '2rem'}}/> : `Create Box`}
                    disabled={loading}/>
            </div>
        </form>
    )
